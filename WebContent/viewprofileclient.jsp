...
String eemail = request.getParameter("cemail");
String ename = request.getParameter("cname");
String edob = request.getParameter("cdob");
String eaddress = request.getParameter("caddress");
String emobile = request.getParameter("cmobile");
%>
...
<html>
    <form action="profileupdateclient" method="POST">
