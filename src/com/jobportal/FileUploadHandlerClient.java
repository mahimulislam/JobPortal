...
@WebServlet("/FileUploadHandlerClient") // at the place of ServletName  
public class FileUploadHandlerClient extends HttpServlet {
...
File deleteFile = new File("/Users/mahimulislam/Desktop/GRE/"+emailss + "profilepic.jpg") ;
// check if the file is present or not
if( deleteFile.exists() )
deleteFile.delete() ;
 fileItem.write(new File("/Users/mahimulislam/Desktop/GRE/"+emailss + "profilepic.jpg"));
 }
 }
